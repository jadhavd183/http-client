...
extension ApiEndpoint where Self: RawRepresentable, RawValue == String  {
    ...
    public func makeRequest(pathComponent: String? = nil) -> URLRequest {
    ...
    public func makeRequest(pathComponent: String? = nil, params: [String: String]) -> URLRequest {
    ...
    public func makeRequest(pathComponent: String? = nil, httpBody: Data) -> URLRequest {
        var request = makeRequest(pathComponent: pathComponent)
